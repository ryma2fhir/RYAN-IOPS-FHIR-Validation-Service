package uk.nhs.england.fhirvalidator.providerR4B
...
import uk.nhs.england.fhirvalidator.provider.ValueSetProvider
                ...
                for (property in lookupCodeResultUK.originalParameters.parameter) {
                    if (property.name.equals("code")) {
                        packagedProductDefinition.addIdentifier()
                            .setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.DMandD)
                                    ...
                                    when (code.value) {
                                        "10363801000001108" -> {
                                            packagedProductDefinition.setType(CodeableConcept().addCoding(
                                                Coding().setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.SNOMED_CT).setCode(code.value).setDisplay("Virtual medicinal product")
                                            ))
                                        }
                                        "10363901000001102" -> {
                                            packagedProductDefinition.setType(CodeableConcept().addCoding(
                                                Coding().setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.SNOMED_CT).setCode(code.value).setDisplay("Actual medicinal product")
                                            ))
                                        }
                                        "10364001000001104" -> {
                                            packagedProductDefinition.setType(CodeableConcept().addCoding(
                                                Coding().setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.SNOMED_CT).setCode(code.value).setDisplay("Actual medicinal product pack")
                                            ))
                                        }
                                        "8653601000001108" -> {
                                            packagedProductDefinition.setType(CodeableConcept().addCoding(
                                                Coding().setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.SNOMED_CT).setCode(code.value).setDisplay("Virtual medicinal product pack")
                                            ))
                                        }
                                        else -> {
                    ...
                    if (codeType != null) {
                        ...
                        val identifier = Identifier().setType(
                            CodeableConcept().addCoding(
                                Coding().setSystem(uk.nhs.england.fhirvalidator.util.FhirSystems.SNOMED_CT).setCode("10363801000001108")
